...
// import Sidebar from "@/components/layout/Sidebar"; // Remove sidebar
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-slate-50 flex flex-col">
      ...
      <div className="flex items-center justify-between">
        ...
        />
        <Button variant="ghost" onClick={handleLogout} className="flex items-center gap-2 text-destructive mr-4 mt-2">
      ...
      <main className="flex-1 p-6 space-y-6 animate-fade-in">
        ...
        {/* Add more analytics, charts, or tabs here if needed */}
      </main>
    </div>
  );
};
